		...
		if(isset($_POST['_submit_check']) && $_POST['_submit_check']!="" && $_POST['_submit_check']!=NULL){ 
			...
			if(validateNewUser()=='valid') //if no errors, create user in db and show success message
			{
				...
				(isset($_POST['accounting_recipient_3']) && $_POST['accounting_recipient_3']!="" && $_POST['accounting_recipient_3']!=NULL) ){ 
					...
					$query = "UPDATE email_recipients SET recipient_1='{$_POST['accounting_recipient_1']}', recipient_2='{$_POST['accounting_recipient_2']}', recipient_3='{$_POST['accounting_recipient_3']}' WHERE step='accounting' ";
				...
				(isset($_POST['accounting_recipient_2']) && $_POST['accounting_recipient_2']!="" && $_POST['accounting_recipient_2']!=NULL) ){ 
					...
					$query = "UPDATE email_recipients SET recipient_1='{$_POST['accounting_recipient_1']}', recipient_2='{$_POST['accounting_recipient_2']}' WHERE step='accounting'";
					...
					*/
					...
					$query = "UPDATE email_recipients SET recipient_1='{$_POST['accounting_recipient_1']}' WHERE step='accounting' ";
					$result = mysqli_query($db,$query);
...
function showPage($username='', $accessLvl = '', $errors = ''){
	...
	//if(isset($_POST['first_name']) && isset($_POST['last_name']) && isset($_POST['username'])){
		...
		print <<<ADDUSERPAGE
			...
			<h2 align="center">Add/Edit Billing Recipients PAR2</h2>
			<form method="POST" action="{$_SERVER['PHP_SELF']}" name="add_acc_rec">
		  <table style="width: 100%" border="1">
			<tbody>
			  		  
			 <tr>
            <td>PAR2 Recipient 1 </td>
            <td>
              <select name="par2_recipient_1">
ADDUSERPAGE;

			$query_users = 'SELECT user_id, first_name, last_name FROM users';
			$result_users = mysqli_query($db,$query_users);
			
			$query_users_rec_1 = "SELECT recipient_1 FROM email_recipients WHERE step='par2' ";
	...
	print <<<EDITUSERPAGE
			  ...
			  <tr>
            <td>PAR2 Recipient 2</td>
            <td>
              <select name="par2_recipient_2">		  
...
EDITUSERPAGE;
			...
			$query_users_rec_2 = "SELECT recipient_2 FROM email_recipients WHERE step='par2' ";
...
print <<<EDITUSERPAGES
              ...
              <br>
		              ...
		              <td>PAR2 Recipient 3</td>

		  <td>
		      <select name="par2_recipient_3">		  
...
EDITUSERPAGES;
			...
			$query_users_rec_3 = "SELECT recipient_3 FROM email_recipients WHERE step='par2' ";
